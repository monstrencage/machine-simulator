...
- <button class="btn btn--primary" title="Réinitialisation" disabled><i class="fas fa-undo"></i></button> : Réinitialise l'exécution, avec la possibilité de changer le mot d'entrée.
